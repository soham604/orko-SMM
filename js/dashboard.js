...
const CLIENT_DATA = {
  ...
  miguel: {
    ...
    scripts: [
      { num: '01', title: {fr:'Visite Propriété Prestige — Processus Premium',en:'Luxury Property Tour — Premium Process'}, hook: {fr:'Cette propriété à [ville] vaut [prix]$. Voici pourquoi mon client l\'a achetée sans stress en 14 jours.',en:'This property in [city] is worth [price]$. Here\'s why my client bought it stress-free in 14 days.'}, structure: {fr:'Reveal propriété haut de gamme → Problème du client (manque de temps, peur de mal investir) → Notre processus structuré étape par étape → Résultat final (chiffres concrets) → CTA premium',en:'Luxury property reveal → Client problem (no time, fear of bad investment) → Our step-by-step structured process → Final result (concrete numbers) → Premium CTA'}, cta: {fr:'DM «🏠» pour un accompagnement sur mesure',en:'DM «🏠» for a tailored experience'}, why: {fr:'David veut un service premium et structuré. Montrer le processus (pas juste la maison) prouve votre valeur. Vos visites sont déjà votre format #1 (5K vues max).',en:'David wants a premium, structured service. Showing the process (not just the house) proves your value. Tours are already your #1 format (5K views max).'} },
      { num: '02', title: {fr:'«Je n\'ai pas le temps» — L\'objection #1',en:'«I Don\'t Have Time» — The #1 Objection'}, hook: {fr:'Mon client gagnait 500K$/an. Il m\'a dit: «je n\'ai pas le temps de vendre ma maison». Voici ce qui s\'est passé.',en:'My client earned $500K/year. He told me: «I don\'t have time to sell my house». Here\'s what happened.'}, structure: {fr:'Accroche avec profil entrepreneur (David) → Son objection «pas le temps» → Comment on a tout pris en charge (gestion clé-en-main) → Résultat: vente au-dessus du prix demandé, zéro stress → Leçon: déléguer = gagner',en:'Hook with entrepreneur profile (David) → His «no time» objection → How we handled everything (turnkey management) → Result: sold above asking, zero stress → Lesson: delegating = winning'}, cta: {fr:'Tu veux le même résultat? DM «TEMPS» 📩',en:'Want the same result? DM «TIME» 📩'}, why: {fr:'«Je n\'ai pas le temps» est la phrase que David répète le plus. Ce script attaque directement sa peur de déléguer et montre que votre service lui SAUVE du temps.',en:'«I don\'t have time» is the phrase David repeats most. This script directly attacks his fear of delegating and shows your service SAVES him time.'} },
      { num: '03', title: {fr:'650 Transactions — Les Preuves Concrètes',en:'650 Transactions — Concrete Proof'}, hook: {fr:'En 650+ transactions, voici l\'erreur qui a coûté le plus cher à mes clients...',en:'In 650+ transactions, here\'s the mistake that cost my clients the most...'}, structure: {fr:'Chiffre d\'autorité (650+ transactions) → Erreur fréquente des entrepreneurs pressés → Exemple réel (montants, délais) → Comment notre processus évite ça → Positionnement: «on protège votre temps ET votre argent»',en:'Authority number (650+ transactions) → Common mistake of busy entrepreneurs → Real example (amounts, timelines) → How our process avoids it → Positioning: «we protect your time AND your money»'}, cta: {fr:'Sauvegarde ce post — tu vas en avoir besoin 📌',en:'Save this post — you\'ll need it 📌'}, why: {fr:'David exige des preuves concrètes et des résultats mesurables. Vos 650 transactions sont votre meilleur actif de crédibilité. Chaque transaction = une histoire de preuve.',en:'David demands concrete proof and measurable results. Your 650 transactions are your best credibility asset. Each transaction = a proof story.'} },
      { num: '04', title: {fr:'Patrimoine Familial — Protéger ce qui compte',en:'Family Legacy — Protecting What Matters'}, hook: {fr:'Mon client m\'a dit: «Miguel, cette maison c\'est pas un investissement. C\'est l\'avenir de mes enfants.»',en:'My client told me: «Miguel, this house isn\'t an investment. It\'s my children\'s future.»'}, structure: {fr:'Citation émotionnelle client/famille → Contexte: entrepreneur occupé, famille prioritaire → Comment l\'immobilier construit un patrimoine durable → Notre rôle: protéger cette vision → Message: «Votre héritage commence aujourd\'hui»',en:'Emotional client/family quote → Context: busy entrepreneur, family is priority → How real estate builds lasting wealth → Our role: protecting that vision → Message: «Your legacy starts today»'}, cta: {fr:'Pour qui construis-tu? Commente 👇',en:'Who are you building for? Comment 👇'}, why: {fr:'L\'objectif long terme de David: construire un patrimoine solide et laisser un héritage. Ce script touche son cœur de décideur et de père. Le contenu personnel/famille génère 4-5% d\'engagement.',en:'David\'s long-term goal: build a solid estate and leave a legacy. This script touches his core as a decision-maker and father. Personal/family content generates 4-5% engagement.'} },
      { num: '05', title: {fr:'Couple d\'Affaires — Miguel & Cynthia',en:'Business Couple — Miguel & Cynthia'}, hook: {fr:'On gère 650+ transactions ET un couple. Voici comment on fait les deux sans exploser. 😅',en:'We manage 650+ transactions AND a relationship. Here\'s how we do both without breaking down. 😅'}, structure: {fr:'Scène relatable couple entrepreneur → Tension humoristique (travail vs vie perso) → Comment on structure nos rôles → Moment authentique de complicité → Message: la confiance dans l\'équipe = la clé',en:'Relatable entrepreneur couple scene → Humorous tension (work vs personal life) → How we structure our roles → Authentic moment of complicity → Message: trust in the team = the key'}, cta: {fr:'Tag quelqu\'un qui comprend cette réalité! 😂',en:'Tag someone who understands this reality! 😂'}, why: {fr:'David cherche un duo structuré et fiable. Montrer votre dynamique couple/business prouve que vous savez gérer la pression. Ce format génère 4-5% d\'engagement et attire les partages.',en:'David is looking for a structured, reliable duo. Showing your couple/business dynamic proves you can handle the pressure. This format generates 4-5% engagement and drives shares.'} },
    ],
    ideas: [
