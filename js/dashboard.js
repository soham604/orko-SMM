...
const CLIENT_DATA = {
  ...
  serujan: {
    ...
    metrics: [
      { label: {fr:'Moy. Vues IG Reels',en:'Avg IG Reels Views'}, value: '688', sub: {fr:'par vidéo (30 dernières)',en:'per video (last 30)'}, tag: {fr:'Vues',en:'Views'}, color: 'blue' },
      { label: {fr:'Moy. Likes IG',en:'Avg IG Likes'}, value: '34.8', sub: {fr:'par publication',en:'per post'}, tag: '0.25%', color: 'blue' },
      { label: {fr:'Moy. Commentaires IG',en:'Avg IG Comments'}, value: '1.4', sub: {fr:'par publication',en:'per post'}, tag: {fr:'Stable',en:'Stable'}, color: 'blue' },
      { label: {fr:'Top Vues (viral)',en:'Peak Views (viral)'}, value: '4,067', sub: {fr:'Elev8 2025 Day 1',en:'Elev8 2025 Day 1'}, tag: {fr:'Record',en:'Peak'}, color: 'green' },
      ...
      { label: {fr:'Meilleurs Jours',en:'Best Posting Days'}, value: {fr:'Mer-Lun',en:'Wed-Mon'}, sub: {fr:'publications quasi quotidiennes',en:'near-daily posting'}, tag: {fr:'Tendance',en:'Pattern'}, color: 'blue' },
    ...
    topContent: [
      { rank: 1, platform: 'Instagram', date: '2025-09-19', topic: {fr:'Elev8 2025 — Jour 1 highlights',en:'Elev8 2025 — Day 1 highlights'}, views: 4067, likes: 344, shares: null, comments: 21, engagement: 9.0 },
      { rank: 2, platform: 'Instagram', date: '2026-03-04', topic: {fr:'Événement 28 février — Blueprint immobilier',en:'Feb 28 Event — Real estate blueprint'}, views: 2486, likes: 95, shares: null, comments: 2, engagement: 3.9 },
      { rank: 3, platform: 'Instagram', date: '2025-10-02', topic: {fr:'Elev8 2025 — Récapitulatif complet',en:'Elev8 2025 — Full recap'}, views: 2479, likes: 162, shares: null, comments: 3, engagement: 6.7 },
      { rank: 4, platform: 'Instagram', date: '2026-03-15', topic: {fr:'400 logements en 6 mois à 22 ans — Podcast',en:'400 units in 6 months at 22 — Podcast'}, views: 1804, likes: 71, shares: null, comments: 4, engagement: 4.2 },
      { rank: 5, platform: 'Instagram', date: '2025-10-29', topic: {fr:'Interview Kobe Bryant — Patrick Bet-David',en:'Kobe Bryant Interview — Patrick Bet-David'}, views: 1545, likes: 71, shares: null, comments: 2, engagement: 4.7 },
      { rank: 6, platform: 'Instagram', date: '2026-03-15', topic: {fr:'Sacrifices du début — parcours entrepreneur',en:'Early sacrifices — entrepreneur journey'}, views: 1117, likes: 58, shares: null, comments: 3, engagement: 5.5 },
      { rank: 7, platform: 'Instagram', date: '2026-03-07', topic: {fr:'10+ ans en immobilier — leçons apprises',en:'10+ years in real estate — lessons learned'}, views: 683, likes: 43, shares: null, comments: 1, engagement: 6.4 },
      { rank: 8, platform: 'Instagram', date: '2026-03-09', topic: {fr:'Le crédit au Québec — levier sous-estimé',en:'Credit in Quebec — underestimated lever'}, views: 448, likes: 16, shares: null, comments: 0, engagement: 3.6 },
      { rank: 9, platform: 'Instagram', date: '2026-03-08', topic: {fr:'Immigrants et crédit — éducation financière',en:'Immigrants and credit — financial education'}, views: 362, likes: 10, shares: null, comments: 0, engagement: 2.8 },
      { rank: 10, platform: 'Instagram', date: '2026-03-16', topic: {fr:'300 ou 1400 personnes — même mission',en:'300 or 1400 people — same mission'}, views: 336, likes: 21, shares: null, comments: 1, engagement: 6.5 },
      { rank: 11, platform: 'Instagram', date: '2026-03-01', topic: {fr:'Small talk — art du réseautage',en:'Small talk — networking mastery'}, views: 307, likes: 14, shares: null, comments: 0, engagement: 4.6 },
      { rank: 12, platform: 'Instagram', date: '2026-03-14', topic: {fr:'Score 680+ — marge de crédit',en:'Score 680+ — line of credit'}, views: 305, likes: 6, shares: null, comments: 0, engagement: 2.0 },
      { rank: 13, platform: 'Instagram', date: '2026-02-27', topic: {fr:'Être propriétaire = privilège, pas droit',en:'Ownership = privilege, not right'}, views: 301, likes: 8, shares: null, comments: 0, engagement: 2.7 },
      { rank: 14, platform: 'Instagram', date: '2026-03-16', topic: {fr:'Podcast — Immigrant devenu titan du financement',en:'Podcast — Immigrant turned financing titan'}, views: 299, likes: 7, shares: null, comments: 0, engagement: 2.3 },
      { rank: 15, platform: 'Instagram', date: '2026-02-23', topic: {fr:'Bien expliquer les détails aux investisseurs',en:'Explain the details to investors'}, views: 286, likes: 8, shares: null, comments: 0, engagement: 2.8 },
    ],
    contentPillars: [
      { name: {fr:'Investissement Immobilier & Financement',en:'Real Estate Investment & Financing'}, pct: 33, color: 'green' },
      { name: {fr:'Éducation Financière / Crédit / Prêt Privé',en:'Financial Education / Credit / Private Lending'}, pct: 23, color: 'blue' },
      { name: {fr:'Elev8 Event & Communauté',en:'Elev8 Event & Community'}, pct: 17, color: 'purple' },
      { name: {fr:'Entrepreneuriat & Mindset',en:'Entrepreneurship & Mindset'}, pct: 17, color: 'orange' },
      { name: {fr:'Personal Branding & Podcast',en:'Personal Branding & Podcast'}, pct: 10, color: 'pink' },
    ],
    hashtags: [
      { tag: '#immobilier', count: 18 },
      { tag: '#investissement', count: 15 },
      { tag: '#business', count: 6 },
      { tag: '#entrepreneur', count: 4 },
      { tag: '#crédit', count: 2 },
      { tag: '#elev8', count: 2 },
      { tag: '#leadership', count: 2 },
      { tag: '#financement', count: 2 },
      { tag: '#entrepreneuriat', count: 2 },
      { tag: '#realestate', count: 2 },
    ],
    postingDesc: {fr:'Publie quasi quotidiennement · Meilleurs jours: Mer-Lun · Format: 97% vidéo/Reels',en:'Posts near-daily · Best days: Wed-Mon · Format: 97% video/Reels'},
    langDesc: {fr:'67% français · 10% anglais · 23% bilingue — Audience investisseurs QC bilingue',en:'67% French · 10% English · 23% bilingual — Bilingual QC investor audience'},
    trends: [
      { icon: '🎤', title: {fr:'Elev8 + événements = engagement massif',en:'Elev8 + events = massive engagement'}, desc: {fr:'Les publications Elev8 (344 likes, 4K+ vues) et l\'événement du 28 février (2,486 vues, 95 likes) surpassent tout de 5-10x. Le contenu événementiel crée un effet communautaire. Capitaliser toute l\'année: témoignages, speakers, coulisses.',en:'Elev8 posts (344 likes, 4K+ views) and the Feb 28 event (2,486 views, 95 likes) outperform everything by 5-10x. Event content creates community effect. Capitalize year-round: testimonials, speakers, BTS.'}, tag: {fr:'LEVIER #1',en:'LEVER #1'}, tagClass: 'tag-green' },
      { icon: '🎙️', title: {fr:'Le podcast = nouveau levier de crédibilité',en:'Podcast = new credibility lever'}, desc: {fr:'Le clip podcast «400 logements à 22 ans» = 1,804 vues et 4.2% engagement. Le format interview positionne Serujan comme autorité. Extraire des clips 30-60 sec avec les meilleures punchlines.',en:'The podcast clip «400 units at 22» = 1,804 views and 4.2% engagement. Interview format positions Serujan as authority. Extract 30-60s clips with best punchlines.'}, tag: {fr:'NOUVEAU FORMAT',en:'NEW FORMAT'}, tagClass: 'tag-blue' },
      { icon: '📊', title: {fr:'L\'éducation financière attire les investisseurs',en:'Financial education attracts investors'}, desc: {fr:'Le contenu crédit/financement (score 680+, crédit immigrants, comparables) génère un engagement constant de 2.5-3.5%. Ces vidéos construisent l\'autorité et génèrent des consultations Calendly. Le public veut comprendre.',en:'Credit/financing content (score 680+, immigrant credit, comparables) generates steady 2.5-3.5% engagement. These videos build authority and drive Calendly consultations. The audience wants to understand.'}, tag: {fr:'CONVERSION',en:'CONVERSION'}, tagClass: 'tag-purple' },
      { icon: '🔥', title: {fr:'Le parcours personnel = connexion émotionnelle',en:'Personal journey = emotional connection'}, desc: {fr:'«Les sacrifices du début» (1,117 vues, 5.5% engagement) et «10+ ans» (683 vues, 6.4%) prouvent que la vulnérabilité convertit. L\'audience suit la personne avant le service. Alterner éducation + storytelling.',en:'«Early sacrifices» (1,117 views, 5.5% engagement) and «10+ years» (683 views, 6.4%) prove vulnerability converts. Audience follows the person before the service. Alternate education + storytelling.'}, tag: {fr:'ENGAGEMENT FORT',en:'HIGH ENGAGEMENT'}, tagClass: 'tag-orange' },
    ],
    scripts: [
      { num: '01', title: {fr:'«Tu peux devenir prêteur privé» — Éducation accessible',en:'«You Can Become a Private Lender» — Accessible Education'}, hook: {fr:'Tu peux devenir prêteur privé bien plus vite que la majorité des gens le pensent. Ton argent peut travailler dans l\'immobilier sans que tu achètes de propriété.',en:'You can become a private lender way faster than most people think. Your money can work in real estate without you buying property.'}, structure: {fr:'Accroche directe (phrase réelle Serujan) → Qu\'est-ce que le prêt privé (30 sec) → 3 avantages: rendement, sécurité, simplicité → Attention: «Beaucoup plus de suivi que tu penses» → La structure fait toute la différence → CTA',en:'Direct hook (Serujan\'s real phrase) → What is private lending (30 sec) → 3 advantages: return, security, simplicity → Warning: «Way more follow-up than you think» → Structure makes all the difference → CTA'}, cta: {fr:'DM «PRÊT PRIVÉ» pour une consultation gratuite de 15 min 📩',en:'DM «PRIVATE LENDING» for a free 15-min consultation 📩'}, why: {fr:'Phrase exacte de Serujan (201 vues). Le prêt privé est sa niche #1 et son différenciateur unique au Québec. Le ton direct et accessible convertit en consultations Calendly.',en:'Serujan\'s exact phrase (201 views). Private lending is his #1 niche and unique differentiator in Quebec. The direct, accessible tone converts to Calendly consultations.'} },
      { num: '02', title: {fr:'«Un bon dossier, ça rassure» — La structure qui finance',en:'«A Good File Reassures» — The Structure That Finances'}, hook: {fr:'Un bon dossier ne sert pas juste à présenter un deal, il sert à rassurer, répondre aux questions et rendre l\'investissement beaucoup plus facile. La structure fait souvent toute la différence.',en:'A solid file doesn\'t just present a deal — it reassures, answers questions, and makes the investment much easier. Structure often makes all the difference.'}, structure: {fr:'Accroche mot pour mot Serujan → La différence entre un dossier refusé et accepté → 5 éléments clés → «Le prêteur veut voir de la confiance, pas juste des chiffres» → Comment Serujan structure les deals → CTA',en:'Serujan\'s word-for-word hook → Difference between rejected and approved file → 5 key elements → «The lender wants to see confidence, not just numbers» → How Serujan structures deals → CTA'}, cta: {fr:'Envoie-moi ton dossier, je te dis en 5 min si ça passe 📲',en:'Send me your file, I\'ll tell you in 5 min if it passes 📲'}, why: {fr:'Citation directe de Serujan (168 vues, 10 likes). Ce format positionne l\'expertise technique. Les investisseurs veulent savoir comment maximiser leurs chances. Fort potentiel de sauvegarde et de partage.',en:'Serujan\'s direct quote (168 views, 10 likes). This format positions technical expertise. Investors want to maximize their chances. High save and share potential.'} },
      { num: '03', title: {fr:'«Être propriétaire, c\'est un privilège» — Vérité directe',en:'«Ownership Is a Privilege» — Direct Truth'}, hook: {fr:'Être propriétaire, ce n\'est pas un droit automatique. C\'est un privilège qui se mérite par l\'éducation, la stratégie et la responsabilité. Sans connaissances, l\'immobilier devient un risque, pas une opportunité.',en:'Being a property owner isn\'t an automatic right. It\'s a privilege earned through education, strategy, and responsibility. Without knowledge, real estate becomes a risk, not an opportunity.'}, structure: {fr:'Phrase choc Serujan → Pourquoi la majorité échoue (pas d\'éducation) → 3 fondamentaux: éducation, stratégie, responsabilité → Exemple concret d\'un investisseur qui a appris → «C\'est pour ça que j\'ai créé Elev8» → CTA',en:'Serujan\'s shock phrase → Why most fail (no education) → 3 fundamentals: education, strategy, responsibility → Concrete example of an investor who learned → «That\'s why I created Elev8» → CTA'}, cta: {fr:'Commente «ÉDUCATION» si t\'es prêt à apprendre avant d\'investir 📋',en:'Comment «EDUCATION» if you\'re ready to learn before investing 📋'}, why: {fr:'Citation exacte de Serujan (301 vues). Le ton direct et assumé renforce le positionnement d\'expert sans compromis. Ce format controversé génère du débat et des partages.',en:'Serujan\'s exact quote (301 views). The direct, confident tone reinforces the uncompromising expert positioning. This controversial format generates debate and shares.'} },
      { num: '04', title: {fr:'«Le crédit des immigrants» — Levier méconnu',en:'«Immigrant Credit» — Misunderstood Lever'}, hook: {fr:'Dans plusieurs communautés immigrantes, le crédit est souvent mal vu. Pourtant, bien utilisé, il peut devenir un levier puissant pour créer de la richesse.',en:'In many immigrant communities, credit is often seen negatively. Yet when used well, it can become a powerful lever to build wealth.'}, structure: {fr:'Accroche culturelle (mot pour mot Serujan) → Le crédit au Québec: «on le prend pour acquis alors que c\'est un des plus grands leviers» → 3 étapes pour immigrants → Exemple concret de client → La confiance se bâtit avec la connaissance → CTA',en:'Cultural hook (Serujan\'s exact words) → Credit in Quebec: «we take it for granted when it\'s one of the biggest levers» → 3 steps for immigrants → Concrete client example → Trust is built with knowledge → CTA'}, cta: {fr:'Tu connais quelqu\'un qui a besoin d\'entendre ça? Tag-le 👇',en:'Know someone who needs to hear this? Tag them 👇'}, why: {fr:'Citations réelles de 2 posts Serujan (362 + 448 vues). Ce sujet touche un public massif et sous-servi. Serujan parle de ce sujet avec authenticité parce qu\'il le vit. Fort potentiel de partage.',en:'Real quotes from 2 Serujan posts (362 + 448 views). This topic reaches a massive, underserved audience. Serujan speaks about this authentically because he lives it. High share potential.'} },
      { num: '05', title: {fr:'«Les sacrifices du début» — Parcours authentique',en:'«Early Sacrifices» — Authentic Journey'}, hook: {fr:'Au début, je faisais des sacrifices que plusieurs n\'auraient jamais acceptés... mais je voyais plus loin que l\'argent du moment. J\'ai vu l\'opportunité, j\'ai appris, j\'ai pris des risques.',en:'At the beginning, I made sacrifices most people would never accept... but I could see beyond the money of the moment. I saw the opportunity, I learned, I took risks.'}, structure: {fr:'Accroche vulnérable (mot pour mot Serujan) → Les sacrifices concrets → «Plus d\'une décennie à maîtriser l\'immobilier» → Les leçons: patience > profit rapide, relations = meilleurs deals, réseau = actif → «Now my goal is to pass that knowledge on» → CTA Elev8',en:'Vulnerable hook (Serujan\'s exact words) → The concrete sacrifices → «Over a decade mastering real estate» → Lessons: patience > quick profit, relationships = best deals, network = asset → «Now my goal is to pass that knowledge on» → CTA Elev8'}, cta: {fr:'300 ou 1400 personnes, la mission reste la même: show up, deliver value 🚀',en:'300 or 1400 people, the mission stays the same: show up, deliver value 🚀'}, why: {fr:'Post #6 le plus vu (1,117 vues, 5.5% engagement). Le storytelling personnel crée la connexion émotionnelle. Combine 3 citations réelles de Serujan pour un arc narratif complet. Positionne naturellement Elev8.',en:'#6 most viewed post (1,117 views, 5.5% engagement). Personal storytelling creates emotional connection. Combines 3 real Serujan quotes for a complete narrative arc. Naturally positions Elev8.'} },
    ],
    ideas: [
      { title: {fr:'Clips Podcast — Le nouveau levier viral',en:'Podcast Clips — The New Viral Lever'}, format: 'Reel / TikTok', platform: 'Both', perf: 'High', desc: {fr:'«400 logements en 6 mois à 22 ans» = 1,804 vues, 4.2% engagement. Le format interview est votre 2e meilleur format après Elev8. Extraire des clips 30-60 sec avec les meilleures punchlines. Chaque épisode = 3-5 Reels.',en:'«400 units in 6 months at 22» = 1,804 views, 4.2% engagement. Interview format is your 2nd best after Elev8. Extract 30-60s clips with best punchlines. Each episode = 3-5 Reels.'}, color: 'green' },
      { title: {fr:'Contenu Elev8 365 — Promo toute l\'année',en:'Elev8 365 — Year-Round Promo'}, format: 'Reel / TikTok', platform: 'Both', perf: 'High', desc: {fr:'Elev8 = votre levier #1 (4K+ vues, 9% engagement). Événement du 28 fév = 2,486 vues. Créez du contenu régulier: témoignages, highlights, speakers, coulisses. Ne limitez pas au jour J.',en:'Elev8 = your #1 lever (4K+ views, 9% engagement). Feb 28 event = 2,486 views. Create regular content: testimonials, highlights, speakers, BTS. Don\'t limit to event day.'}, color: 'green' },
      { title: {fr:'«Immigrer & Investir» — Série crédit culturel',en:'«Immigrate & Invest» — Cultural Credit Series'}, format: 'Talking Head', platform: 'Instagram', perf: 'High', desc: {fr:'2 posts sur le sujet (362 + 448 vues). Le crédit immigrant touche un public massif et sous-servi. Serujan parle d\'expérience. Série hebdomadaire: mythes, étapes, leviers. Fort potentiel de partage.',en:'2 posts on this topic (362 + 448 views). Immigrant credit reaches a massive, underserved audience. Serujan speaks from experience. Weekly series: myths, steps, levers. High share potential.'}, color: 'green' },
      { title: {fr:'«Vérités qui dérangent» — Format polémique',en:'«Uncomfortable Truths» — Controversial Format'}, format: 'Reel / TikTok', platform: 'Instagram', perf: 'High', desc: {fr:'«Être propriétaire c\'est un privilège» + «Arrête de tout faire seul» = ton direct qui engage. Série de phrases-chocs qui challengent les croyances. Engagement garanti par le débat.',en:'«Ownership is a privilege» + «Stop doing everything alone» = direct tone that engages. Series of shock phrases that challenge beliefs. Guaranteed engagement through debate.'}, color: 'blue' },
      { title: {fr:'Série «Levier Crédit QC» — Éducation finance',en:'«QC Credit Lever» Series — Finance Education'}, format: 'Reel / TikTok', platform: 'Instagram', perf: 'Medium', desc: {fr:'Score 680+, marge de crédit, comparables vs évaluation agréée — chaque concept = 1 Reel. Format éducatif sauvegardable. Engagement constant 2.5-3.5%. Positionne l\'expertise technique.',en:'Score 680+, line of credit, comparables vs appraisal — each concept = 1 Reel. Saveable educational format. Steady 2.5-3.5% engagement. Positions technical expertise.'}, color: 'blue' },
      { title: {fr:'Storytelling Personnel — Sacrifices & parcours',en:'Personal Storytelling — Sacrifices & Journey'}, format: 'Talking Head', platform: 'Both', perf: 'High', desc: {fr:'«Les sacrifices du début» = 1,117 vues et 5.5% engagement. Le contenu vulnérable surperforme en engagement. Alterner 1 post éducatif + 1 post personnel. L\'audience suit la personne avant le service.',en:'«Early sacrifices» = 1,117 views and 5.5% engagement. Vulnerable content outperforms on engagement. Alternate 1 educational + 1 personal post. Audience follows the person before the service.'}, color: 'blue' },
      { title: {fr:'«Avant/Après Dossier» — Transformation client',en:'«Before/After File» — Client Transformation'}, format: 'Reel / TikTok', platform: 'Instagram', perf: 'High', desc: {fr:'«Un bon dossier rassure, répond aux questions et rend l\'investissement plus facile.» Montrez la transformation: dossier refusé → accepté. Format visuel + preuve sociale.',en:'«A good file reassures, answers questions, and makes investing easier.» Show transformation: rejected → approved file. Visual format + social proof.'}, color: 'green' },
      { title: {fr:'Réseautage & Small Talk — Soft skills d\'affaires',en:'Networking & Small Talk — Business Soft Skills'}, format: 'Reel / TikTok', platform: 'Instagram', perf: 'Medium', desc: {fr:'«Le small talk, c\'est un art» (307 vues, 4.6%). Contenu différenciant vs les autres courtiers. Série: réseautage, communication, comment être mémorable. Humanise la marque Serujan.',en:'«Small talk is an art» (307 views, 4.6%). Differentiating content vs other brokers. Series: networking, communication, being memorable. Humanizes the Serujan brand.'}, color: 'orange' },
    ],
  },
};
